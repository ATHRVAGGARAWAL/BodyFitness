...
/** Compact metric surface for grids of numbers. */
export function DataTile({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn("rounded-lg border border-border bg-muted px-4 py-3", className)} {...props} />;
}
