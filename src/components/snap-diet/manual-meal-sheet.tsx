  ...
  return (
    <Drawer.Root open={open} onOpenChange={handleOpenChange} shouldScaleBackground={false}>
      <Drawer.Portal>
        ...
        <Drawer.Content className="glass-sheet fixed bottom-0 left-1/2 z-[95] w-full max-w-[430px] -translate-x-1/2 rounded-t-[30px] px-5 pb-[calc(25px+var(--safe-bottom))] pt-3 outline-none">
